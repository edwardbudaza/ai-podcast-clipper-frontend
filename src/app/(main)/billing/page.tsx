...
function PricingCard({ plan }: { plan: PricingPlan }) {
  return (
    <Card className={cn('relative flex flex-col', plan.isPopular && 'border-primary border-2')}>
      {plan.isPopular && (
      ...
      <div className="relative flex items-center justify-center gap-4">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground">
            Purchase credits to generate more podcast clips. The more credtis you buy, the better
            the value.
          </p>
        </div>
      </div>
